...
#define upButton 2    // UpButton Pin
#define downButton 1  // Down BUtton Pin
#define maxSpeed 800  // max motor speed
#define Speed 800     // current speed
#define setAccel 1000 // stepper accelaration
#define buzzerPin 10
#define ledPin 8

// SETTINGS - MAIN PARAMETERS
#define stepsPerRevolution 10240 //Bylo 2048 //set number motor steps for wheel to rotate once
#define numberOfFilters 5
#define offSetResolution 5 //number of motor steps for one offset change
#define homingOffsetSteps 1235 // number of steps from homing point to centre of first filter
#define buzzerConnected 1 //1 to enable on pin 2, 0 to disable
#define ledConnected 1 //1 to enable on pin 3, 0 to disable 

// SETTINGS - MOTOR
#define IN1 9 // unipolar motor pins (set all pins)
#define IN2 7 //motor driver step pin
#define IN3 4
#define IN4 3 //motor driver dir pin
...
#define analogSensorThreshold 1800 // set the threshold below which the homing sensor is triggered
...
U8G2_SSD1306_72X40_ER_F_HW_I2C u8g2(U8G2_R0, /* reset=*/ U8X8_PIN_NONE); // I2C display
...
char currentPosChar[6];         // for display
...
{ // locate home
  ...
  do
  {
    ...
    sendSerial("Hall: " + String(HallValue));
  ...
  currPos = 0;                   // set filter position as 0 (i.e homed).
	sendSerial("At home" + String(HallValue));
...
void loop()
{
  ...
  itoa(currPos, currentPosChar, 6);
  u8g2.clearBuffer();					// clear the internal memory  
  u8g2.setFont(u8g2_font_ncenB24_tf);
  u8g2.drawStr(25, 35, currentPosChar);
